...
- For core concept / definition / component pages, prefer layout_hint "content-icon-rows" with bullets shaped as concept name plus short explanation. This maps cleanly to PPTD concept-diagram pages.

...
from .content import ContentApplicationService
...
class DiegoApplication:
    def __init__(self, orchestrator: Any) -> None:
        ...
        self.content = ContentApplicationService(orchestrator)
    ...
    async def create_content_run(self, req: Any):
        return await self.content.create_run(req)

    async def get_run_detail(self, run_id: str):
        return await self.runs.get_run_detail(run_id)

    async def get_content_run_detail(self, run_id: str):
        return await self.content.get_run_detail(run_id)
    ...
    async def confirm_content_plan(self, run_id: str, req: Any):
        return await self.content.confirm_plan(run_id, req)

    async def revise_content_section(self, run_id: str, section_id: str, req: Any):
        return await self.content.revise_section(run_id, section_id, req)
